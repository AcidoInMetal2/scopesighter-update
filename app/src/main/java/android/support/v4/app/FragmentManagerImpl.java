...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Code duplicated, block: B:148:0x031b  */
    /* JADX WARN: Code duplicated, block: B:150:0x031f  */
    /* JADX WARN: Code duplicated, block: B:153:0x033d  */
    /* JADX WARN: Code duplicated, block: B:155:0x0341  */
    /* JADX WARN: Code duplicated, block: B:158:0x035c  */
    /* JADX WARN: Code duplicated, block: B:160:0x0360  */
    /* JADX WARN: Code duplicated, block: B:163:0x037a  */
    /* JADX WARN: Code duplicated, block: B:170:0x0393  */
    /* JADX WARN: Code duplicated, block: B:174:0x03a8  */
    /* JADX WARN: Code duplicated, block: B:181:0x03c3  */
    /* JADX WARN: Code duplicated, block: B:184:0x03c8  */
    /* JADX WARN: Code duplicated, block: B:188:0x03dc  */
    /* JADX WARN: Code duplicated, block: B:190:0x03e0  */
    /* JADX WARN: Code duplicated, block: B:192:0x03e6  */
    /* JADX WARN: Code duplicated, block: B:193:0x03f1  */
    /* JADX WARN: Code duplicated, block: B:195:0x03f7  */
    /* JADX WARN: Code duplicated, block: B:198:0x0407  */
    /* JADX WARN: Code duplicated, block: B:218:0x0455  */
    /* JADX WARN: Code duplicated, block: B:222:? A[RETURN, SYNTHETIC] */
    /* JADX WARN: Instruction removed from duplicated block: B:150:0x031f, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:155:0x0341, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:160:0x0360, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:218:0x0455, please report this as an issue */
    void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        int i4;
        AnimationOrAnimator animationOrAnimatorLoadAnimation;
        ViewGroup viewGroup;
        String resourceName;
        int i5 = 1;
                ...
                switch (fragment.mState) {
                        ...
                        if (i6 < 2) {
                            ...
                            if (fragment.mView != null && fragment.mContainer != null) {
                                ...
                                if (this.mCurState > 0 || this.mDestroyed || fragment.mView.getVisibility() != 0 || fragment.mPostponedAlpha < 0.0f) {
                                    animationOrAnimatorLoadAnimation = null;
                                } else {
                                    animationOrAnimatorLoadAnimation = loadAnimation(fragment, i2, false, i3);
                                }
                    ...
                    case 3:
                        ...
                        if (i6 < 1) {
                            if (this.mDestroyed) {
                                if (fragment.getAnimatingAway() != null) {
                                    View animatingAway3 = fragment.getAnimatingAway();
                                    fragment.setAnimatingAway(null);
                                    animatingAway3.clearAnimation();
                                } else if (fragment.getAnimator() != null) {
                    ...
                    case 4:
                        ...
                        if (i6 < 1) {
                            if (this.mDestroyed) {
                                if (fragment.getAnimatingAway() != null) {
                                    View animatingAway4 = fragment.getAnimatingAway();
                                    fragment.setAnimatingAway(null);
                                    animatingAway4.clearAnimation();
                                } else if (fragment.getAnimator() != null) {
                                    Animator animator4 = fragment.getAnimator();
                                    fragment.setAnimator(null);
                                    animator4.cancel();
                                }
                            }
                    ...
                    case 5:
                        ...
                        if (i6 < 1) {
                            if (this.mDestroyed) {
                                if (fragment.getAnimatingAway() != null) {
                                    View animatingAway5 = fragment.getAnimatingAway();
                                    fragment.setAnimatingAway(null);
                                    animatingAway5.clearAnimation();
                                } else if (fragment.getAnimator() != null) {
                                    Animator animator5 = fragment.getAnimator();
                                    fragment.setAnimator(null);
                                    animator5.cancel();
                                }
                            }
