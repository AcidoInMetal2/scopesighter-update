...
public class ViewPager extends ViewGroup {
    ...
    /* JADX WARN: Code duplicated, block: B:65:0x00ff A[PHI: r7 r10 r15
  ...
  0x00ff: PHI (r15v6 int) = (r15v5 int), (r15v4 int), (r15v9 int) binds: [B:63:0x00f4, B:60:0x00de, B:54:0x00c8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x00ba A[DONT_INVERT] */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8 && (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) != null && layoutParams2.isDecor) {
                ...
                int i9 = layoutParams2.gravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor;
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    int i10 = layoutParams.gravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor;
                    if (i9 == 1) {
