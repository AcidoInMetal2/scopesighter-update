...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            layoutParamsGenerateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
            layoutParamsGenerateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (!zShouldLayout || zShouldLayout2) {
                ...
                i5 = this.mGravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor;
                i6 = iMin2;
                if (i5 == 48) {
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = 8388611 | (Toolbar.this.mButtonGravity & com.reddington.scopesighter.R.styleable.AppCompatTheme_windowFixedHeightMajor);
                layoutParamsGenerateDefaultLayoutParams.mViewType = 2;
